...
![This image has an empty alt attribute; its file name is image-4.png](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201%201'%3E%3C/svg%3E)
...
![This image has an empty alt attribute; its file name is image-5.png](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201%201'%3E%3C/svg%3E)

**5. Setup the configuration file**

Step A: Check [ethgasstation.info](https://ethgasstation.info/) to see what is the current GWEI![This image has an empty alt attribute; its file name is image-1.png](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201%201'%3E%3C/svg%3E)
...
**Note:** Users reported that Metamask calculates the transaction with the maximum possible gas fee of 8.9 mil gas, and as such would display the transaction will cost more than $50 USD. Should this happen, click on Edit and adjust the gas limit to 200 000 only.![This image has an empty alt attribute; its file name is image-9.png](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201%201'%3E%3C/svg%3E)
...
In the manage section in the user area, select Monitoring and click on Create Alert Policy.![This image has an empty alt attribute; its file name is image-1-1024x284.png](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201%201'%3E%3C/svg%3E)

Configure the alert as below![This image has an empty alt attribute; its file name is image-3-1024x571.png](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201%201'%3E%3C/svg%3E)
...
Go to [Etherscan.io](https://etherscan.io/) and search for your operational wallet public address![This image has an empty alt attribute; its file name is image-6-1024x402.png](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201%201'%3E%3C/svg%3E)

Click on the ERC20 Token Txns section \(1\) and locate the outgoing transaction of 3000 TRAC and click on the respective Txn Hash \(2\) on the left.![This image has an empty alt attribute; its file name is image-7-1024x374.png](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201%201'%3E%3C/svg%3E)

Then on the Transaction Hash screen click on the Internal Txns \(1\) and you will see the ERC725 identity there \(2\). Click on it.![This image has an empty alt attribute; its file name is image-8-1024x325.png](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201%201'%3E%3C/svg%3E)

Click to copy the ERC725 identity \(1\), which is basically the Contract number on the left of the button.![This image has an empty alt attribute; its file name is image-10-1024x294.png](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201%201'%3E%3C/svg%3E)
